...
public class _151 {
	...
	public String reverseWords(String s) {
		...
		for(char currChar: s.toCharArray()) {
			if(currChar == ' ') {
				if(wordBuilder.length() != 0) wordStack.push(wordBuilder.toString());
				wordBuilder = null;
		...
		int answerLen = answerStringBuilder.length();
		if(answerLen != 0) answerStringBuilder.deleteCharAt(answerLen-1);
